# Campaigner - incremental FTP sync to futuremagic.de
#
...
param(
    ...
    [string]$RemotePath = "/webseiten/Campaigner/",
    [string]$BasePath = "/Campaigner/",
    [string]$PublicUrl = "https://futuremagic.de/Campaigner/",
    [string]$Slug = "Campaigner",
    [string]$Title = "Campaigner"
)
...
Write-Host "Starting DIFF SYNC Campaigner deployment..." -ForegroundColor Cyan
