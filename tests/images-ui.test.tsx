...
describe('images ui', () => {
  ...
  it('opens the artifact lightbox fullscreen: viewport-filling dialog, contain-fit image, footer strip intact', async () => {
    ...
    expect(footer.textContent).toContain(
      '64×64 · image/webp · generated by google/gemini-2.5-flash-image',
    );
    // The seeded image is already the cover → the button stays disabled.
    expect(within(footer).getByRole('button', { name: /Cover image/ })).toBeDisabled();
