...
```
reconciled: 778a8f7 · 2026-09-26T12:45Z (GALLERY FAVOURITES REVERTED at the owner's request — wrong chat; the work is preserved on branch `gallery-favourites-stashed` at `be6099f`, recoverable by cherry-pick. The chat-removal VERDICT pins (367), GM assist (362), the adversarial arc (352-360) and the persona change (365) are unaffected. STILL HIS: Reset-to-default on the three personas, the iPad scroll check, and whether the chat button should say "Delete". QUEUED: 361, 363-364.)
