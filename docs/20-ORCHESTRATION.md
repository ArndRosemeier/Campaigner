...
IN-FLIGHT | row=340 | state=DISPATCHED | writer=34896b7f-7d78-474b-bb4b-12126470c2d9 | worktree=/home/administrator/projects/Campaigner/worktrees/spawn-scroll | branch=spawn-scroll | model=deepseek-official/deepseek-flash (inherited route) | note=the spawn dialog scroll fix (ONE scroller + svh cap); brief `.gate-logs/briefs/row340.md`; reports ON LANDING or BLOCKED only.
