...
IN-FLIGHT | row=349 | state=DISPATCHED | writer=429458ce-8618-469a-b5f7-4f6fcadf4411 | worktree=/home/administrator/projects/Campaigner/worktrees/statless-repair | note=OWNER CHOSE (A): heal name-only roster rows by COPYING library stats. DISPATCHER ERROR: brief+row 349 named `db/mobCopyRepair`, DELETED by `89c55e8` — the landing rides `db/libraryCopy`, `domain/libraryCreature`, `battleRepo.healBattleBoardMap`. `initiativeBonus` is null for every token; heal sets `artifactId`/`currentHp`.
