...
IN-FLIGHT | row=336 | state=DISPATCHED | writer=8fec753e-f769-4d26-94dc-473dde90d850 | worktree=/home/administrator/projects/Campaigner/worktrees/spawn-fix | branch=spawn-fix | model=deepseek-official/deepseek-flash (inherited route) | note=three spawn defects (lost update A, hidden checkbox B, iPad layout C); brief `.gate-logs/briefs/row336.md`; reports ON LANDING or BLOCKED only.
