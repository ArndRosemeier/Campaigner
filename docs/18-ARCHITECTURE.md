...
explicit caller-chosen set of campaign-level rows; plain confirm, docs/17 row
322) → **per-region remove all** (`artifactRepo.deleteArtifactsOfKind` — one
