...
- **An offer the deleter will refuse is a bug** (ledger 92). The orphan
  ...
  (the campaign-wide mention gate, battle tokens/seeds, deliverable outline
  nodes) is closed by RECORDING the sweep's refusals in the panel's view
